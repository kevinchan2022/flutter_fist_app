class KnowledgeDetailData {
  ...
  KnowledgeDetailData.fromJson(Map<String, dynamic> json) {
    curPage = (json["curPage"] as num).toInt();
    datas = json["datas"] == null
        ? null
        : (json["datas"] as List)
            .map((e) => KnowledgeDetailItem.fromJson(e))
            .toList();
